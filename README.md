...
* Open Blender
* Find Add-ons in this path: Edit > Prefernces > Add-ons
* Press button "Install an add-on"
* Choose zip-file of BST and press "Install Add-on from File"
* Enable BST and it's all. Enjoy :)
